...
| `POST` | `/simulate/network-failure` | Simulate network failure & trigger agent |
| `GET` | `/orders` | List orders |
| `GET` | `/orders/{id}/audit` | Full audit trail of decisions |
| `GET` | `/stats` | Recovery rate & metrics |
...
## Author
**Amardeep Kumar**  
GitHub: [amardeepgit8759](https://github.com/amardeepgit8759)
